<?php
    ...
    class FaqController extends Controller
    {
        ...
        public function storeFaqs(Request $request)
        {
            ...
            Faq::create($in);
            $notification = ['message' => 'FAQS Created Successfully.', 'alert-type' => 'success'];
        ...
        public function updateFaqs(Request $request, $id)
        {
            ...
            $notification = ['message' => 'FAQS Updated Successfully.', 'alert-type' => 'success'];
            return back()->with($notification);
        ...
        public function deleteFaqs(Request $request)
        {
            ...
            $notification = ['message' => 'FAQS Deleted Successfully.', 'alert-type' => 'success'];
            return back()->with($notification);
        }
