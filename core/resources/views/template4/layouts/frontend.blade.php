                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link" @if(request()->path() == '/') href="#home" @else href="{{url('/')}}#home" @endif>@lang('Home') </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" @if(request()->path() == '/') href="#about" @else href="{{url('/')}}#about"  @endif>@lang('About')</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" @if(request()->path() == '/') href="#service" @else href="{{url('/')}}#service"  @endif>@lang('Services')</a>
                                        </li>


                                        <li class="nav-item">
                                            <a class="nav-link" @if(request()->path() == '/') href="#plan" @else href="{{url('/')}}#plan"  @endif>@lang('Plan')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" @if(request()->path() == '/') href="#faq" @else href="{{url('/')}}#faq"  @endif>@lang('FAQ')</a>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="{{url('login')}}">@lang('Sign In')</a>
                                                <a class="dropdown-item" href="{{url('register')}}">@lang('Sign Up')</a>
