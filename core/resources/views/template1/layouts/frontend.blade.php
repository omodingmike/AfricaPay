                            ...
                            <li><span class="icon"><i class="fa fa-language"></i></span>
                                <select id="langSel">
                                    ...
                                    @foreach($lang as $data)
                                        <option value="{{$data->code}}" @if(Session::get('lang') === $data->code) selected
                                                @endif style="color: black"> {{__($data->name)}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="col-xl-2 col-lg-2">
                    <div class="social">
                        ...
                        @foreach($social as $key => $data)
                            <a href="{{$data->link}}" style="background-color: rgba(255, 255, 255, 0.8);" target="_blank"><i
                                        style="color: #{{$general->color}}" class="fa fa-{{$data->icon}}"></i></a>
                        @endforeach
                    </div>
                </div>
            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul id="navbar-nav" class="navbar-nav mr-auto justify-content-center">
                                    ...
                                    <li class="nav-item active">
                                        <a class="nav-link" @if(request()->path() == '/') href="#home"
                                           @else href="{{url('/')}}#home" @endif>@lang('Home') </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" @if(request()->path() == '/') href="#service"
                                           @else href="{{url('/')}}#service" @endif>@lang('Services')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" @if(request()->path() == '/') href="#about"
                                           @else href="{{url('/')}}#about" @endif>@lang('About')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" @if(request()->path() == '/') href="#plan"
                                           @else href="{{url('/')}}#plan" @endif>@lang('Plan')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" @if(request()->path() == '/') href="#faq"
                                           @else href="{{url('/')}}#faq" @endif>@lang('FAQ')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('fornt.blog')}}">@lang('Knowledge Base')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('contact.front')}}">@lang('Contact')</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
                        ...
                        <ul>
                            @foreach($social as $key=> $data)
                                <li><a href="{{$data->link}}" style="background-color: rgba(255, 255, 255, 0.8);"><i
                                                style="color: #{{$general->color}}" class="fa fa-whatsapp"></i></a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
