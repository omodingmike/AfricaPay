            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeIn">
                        <li><a @if(request()->path() == '/') href="#home" @else href="{{url('/')}}#home" @endif>@lang('Home')</a></li>
                        <li><a @if(request()->path() == '/') href="#service" @else href="{{url('/')}}#service"  @endif>@lang('Services')</a></li>
                        <li><a @if(request()->path() == '/') href="#about" @else href="{{url('/')}}#about"  @endif>@lang('About')</a></li>
                        <li><a @if(request()->path() == '/') href="#plan" @else href="{{url('/')}}#plan"  @endif>@lang('Plan')</a></li>
                        <li><a  @if(request()->path() == '/') href="#faq" @else href="{{url('/')}}#faq"  @endif>@lang('FAQ')</a></li>
                        <li><a  href="{{route('fornt.blog')}}">@lang('Knowledge Base')</a></li>
                        <li><a  href="{{route('contact.front')}}">@lang('Contact')</a></li>
                        @guest
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">@lang('Account')</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{url('login')}}">@lang('Sign In')</a></li>
                                <li><a href="{{url('register')}}">@lang('Sign Up')</a></li>
                            </ul>
                        </li>
                        @else
